  ...
  render() {
    return (
      <div>
        ...
        <br />
        <Input type="text" name={this.props.name} value={this.props.value || ''} required={this.props.isRequired} onChange={this.props.onChange} />
...
class SubmitForm extends Component {
  ...
  handleSubmit = (event) => {
    ...
    console.log(this.props.submission.formSchema);
